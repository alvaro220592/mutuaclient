<template>
    <div>
        <TituloPagina titulo="Suas doações oferecidas" />
        ...
        <BotaoFlutuanteNovoCadastro nomeRota="doacoes.oferecidas.novo" />
    </div>
</template>
...
import { buscarOferecidas } from 'src/services/doacao'
...
// uma página de doações oferecidas.
const paginacao = useRolagemInfinita(
    async function (pagina) {
        const dados = await buscarOferecidas(pagina)
